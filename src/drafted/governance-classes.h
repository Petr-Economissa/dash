 ...
 *
 *   // network
 *   CGvidonNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.gvidon.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGvidonNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: GvidonNetwork
// //   -- signature requirements : Key1(User)
// class CGvidonNetworkVariable : public CGovernanceObject
// {
// private:
