...
{
public:
    /// Is the input associated with this public key? (and there is 1000 GVIDON - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of gvidon.
