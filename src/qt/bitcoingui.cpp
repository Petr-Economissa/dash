    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Gvidon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gvidon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gvidon: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Gvidon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gvidon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gvidon Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gvidon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gvidon addresses"));
    ...
    openAction->setStatusTip(tr("Open a gvidon: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gvidon Core help message to get a list with possible Gvidon Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gvidon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gvidon network", "", count));
}
...
{
    QString strTitle = tr("Gvidon Core"); // default title
