...
{
    if(fLiteMode) return; // ignore all Gvidon related functionality
...
/*
    ...
    allow endless transaction that would bloat Gvidon and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("gvidon-privatesend");
